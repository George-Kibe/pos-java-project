...
test("an administrator navigates to every right it holds and manages non-admin users page by page", async ({ page }) => {
  ...
  const expected = ["Till", "Dashboard", "Reports", "Products", "Catalog setup", "Pricing", "Stock", "Purchasing", "Expenses", "Suppliers", "Customers", "Cash", "Users", "Roles", "Branches", "Settings", "Audit", "Devices", "Manual", "Account"];
